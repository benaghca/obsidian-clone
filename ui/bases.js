...
(function (root) {
  // YAML and frontmatter come from ui/yaml.js (shared with the vault index and Properties).
  const Y = root.CinderYaml || require('./yaml.js');
  const { parse: parseYaml, emit: emitYaml, scalar, key: yamlKey, frontmatter, FM_RE } = Y;
