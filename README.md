...
- **Drawings**, an Excalidraw-style whiteboard with a hand-drawn look. It has rectangles, diamonds, ellipses, arrows, lines, freehand pen, text, images, an eraser and a **laser pointer** (**K**). The laser draws a glowing red trail that fades after a second and never changes the drawing, which is handy for pointing things out while presenting. Features:
